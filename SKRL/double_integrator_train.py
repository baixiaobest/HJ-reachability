...
class Value(Model):
    ...
    def compute(self, inputs, role):
        ...
        return values, {}, {}  # Return three elements: values, log_prob (empty), entropy (empty)
...
def main():
    ...
    policy = Policy(env.observation_space, env.action_space, device, **models_config["policy"])
    ...
    # Save agent models
    agent.save("./models/ppo_double_integrator_skrl_{timestamp}")
